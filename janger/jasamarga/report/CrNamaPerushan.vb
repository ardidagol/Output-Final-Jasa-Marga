...
Public Class CrNamaPerushan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "jasamarga.CrNamaPerushan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_para_nama() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrNamaPerushan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrNamaPerushan = New CrNamaPerushan()
        rpt.Site = Me.Site
        Return rpt
    End Function
