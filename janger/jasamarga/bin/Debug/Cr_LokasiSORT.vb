...
Public Class Cr_LokasiSORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "jasamarga.Cr_LokasiSORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_LokasiA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_LokasiSORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_LokasiSORT = New Cr_LokasiSORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
