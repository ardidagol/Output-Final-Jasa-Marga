...
Public Class Laporan_bulananED
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "jasamarga.Laporan_bulananED.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_bulananED
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_bulananED = New Laporan_bulananED()
        rpt.Site = Me.Site
        Return rpt
    End Function
